...
// const first = document.querySelector(".first__test")
// first.innerHTML = data[0].description
// const second = document.querySelector(".second__test")
// second.innerHTML = data[1].description